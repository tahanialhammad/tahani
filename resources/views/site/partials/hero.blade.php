    {{-- Hero Section --}}
    <section id="hero">
        <div class="container mx-auto px-8 space-x-8 flex flex-col-reverse md:flex-row">
            ...
            <div class="md:w-1/2 flex flex-col justify-center space-y-6 py-6 text-center md:text-left text-slate-900">
                ...
                <a href=""
                    class="py-2 px-6 rounded-full self-center md:self-start bg-red-500 text-white hover:bg-slate-900">contact</a>
            </div>


            <div class="md:w-1/2">
                <img src="{{ Vite::asset('resources/images/undraw_hero.svg') }}">
            </div>
        </div>
    </section>
